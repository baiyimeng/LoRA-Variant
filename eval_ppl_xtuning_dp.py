...
def parse_arguments():
    ...
    parser.add_argument(
        "--peft_model_id",
        type=str,
        default="/root/autodl-tmp/output/Qwen2.5-7B-Instruct/plora_1.0/checkpoint-1617",
    )
...
def evaluation(args):
    ...
    model = XPeftModel.from_pretrained(model, args.peft_model_id)
